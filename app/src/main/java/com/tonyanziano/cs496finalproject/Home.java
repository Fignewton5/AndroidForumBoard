...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get prompt
        uploadPrompt = (RelativeLayout) findViewById(R.id.upload_prompt);
            ...
            public void onResponse(JSONArray response) {
                ...
                for(int i = 0; i < response.length(); i++){
                    try {
                        ...
                        ListView titleCol = (ListView) findViewById(R.id.home_title_column);
                        ListView authorCol = (ListView) findViewById(R.id.home_author_column);
                        //now take the arrays and map them to our vertical linear layouts
                        ArrayAdapter<String> titleAdapter = new ArrayAdapter<String>(Home.this, R.layout.forum_post_list, titles);
                        ArrayAdapter<String> authorAdapter = new ArrayAdapter<String>(Home.this, R.layout.forum_post_list, authors);
                        //connect adapters
